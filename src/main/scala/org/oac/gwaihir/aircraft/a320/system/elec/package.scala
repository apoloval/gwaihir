...
package object elec {
  ...
  val DcEssTieContId = DcSubsystemId / "EssTieCont"
  val DcEssTrId = DcSubsystemId / "EssTr"
  val DcEssTrContId = DcSubsystemId / "EssTrCont"
  ...
  val StaticInvOneContId = DcSubsystemId / "StaticInv1Cont"
  val StaticInvTwoContId = DcSubsystemId / "StaticInv2Cont"
}
